...
var ReportsService = exports.ReportsService = function () {
    ...
    var ReportsService = _classThis = /** @class */ (function () {
         ...
         */
        function ReportsService_1(repo) {
            this.repo = repo;
        }
        ReportsService_1.prototype.create = function (reportDto, user) {
            var report = this.repo.create(reportDto);
            report.user = user;
            return this.repo.save(report);
        };
        ReportsService_1.prototype.changeApprovalStatus = function (id, approved) {
        ...
        ReportsService_1.prototype.createEstimate = function (_a) {
